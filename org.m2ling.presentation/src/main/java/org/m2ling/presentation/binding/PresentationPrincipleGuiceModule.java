...
import org.m2ling.presentation.principles.EnumerationPopupContent;
...
import org.m2ling.service.models.ComponentServiceImpl;
	...
	protected void configure() {
		{// Injection bindings
			...
			install(new FactoryModuleBuilder().implement(ViewPointDialog.class, ViewPointDialog.class)
					...
					.implement(EnumerationPopupContent.class, EnumerationPopupContent.class)
