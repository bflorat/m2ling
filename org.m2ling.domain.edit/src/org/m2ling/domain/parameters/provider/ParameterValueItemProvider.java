...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.parameters.ParameterValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterValueItemProvider
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterValue_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterValue_parent_feature", "_UI_ParameterValue_type"),
				 ParametersPackage.Literals.PARAMETER_VALUE__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterValue_definition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterValue_definition_feature", "_UI_ParameterValue_type"),
				 ParametersPackage.Literals.PARAMETER_VALUE__DEFINITION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ParametersPackage.Literals.PARAMETER_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ParameterValue)object).getComment();
