...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider
	...
	protected void addStakeholdersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_stakeholders_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_stakeholders_feature", "_UI_Actor_type"),
				 CorePackage.Literals.ACTOR__STAKEHOLDERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_unit_feature", "_UI_Actor_type"),
				 CorePackage.Literals.ACTOR__UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUsernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_username_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_username_feature", "_UI_Actor_type"),
				 CorePackage.Literals.ACTOR__USERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAdminPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_admin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_admin_feature", "_UI_Actor_type"),
				 CorePackage.Literals.ACTOR__ADMIN,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Pwd Hash feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPwdHashPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_pwdHash_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_pwdHash_feature", "_UI_Actor_type"),
				 CorePackage.Literals.ACTOR__PWD_HASH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
