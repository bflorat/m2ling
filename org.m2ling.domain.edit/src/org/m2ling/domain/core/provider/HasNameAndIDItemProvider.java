...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.HasNameAndID} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HasNameAndIDItemProvider
	 ...
	 * @generated
	 */
	public HasNameAndIDItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((HasNameAndID)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HasNameAndID_type") :
			getString("_UI_HasNameAndID_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HasNameAndID.class)) {
