...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.OCLConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OCLConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OCLConstraint_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OCLConstraint_expression_feature", "_UI_OCLConstraint_type"),
				 CorePackage.Literals.OCL_CONSTRAINT__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((OCLConstraint)object).getExpression();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OCLConstraint.class)) {
			case CorePackage.OCL_CONSTRAINT__EXPRESSION:
