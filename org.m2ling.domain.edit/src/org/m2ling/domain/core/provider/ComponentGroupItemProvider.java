...
public class ComponentGroupItemProvider extends ArchitectureItemItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentGroup_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentGroup_components_feature", "_UI_ComponentGroup_type"),
				 CorePackage.Literals.COMPONENT_GROUP__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.COMPONENT_GROUP__REFERENCES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentGroup"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComponentGroup.class)) {
			case CorePackage.COMPONENT_GROUP__REFERENCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.COMPONENT_GROUP__REFERENCES,
