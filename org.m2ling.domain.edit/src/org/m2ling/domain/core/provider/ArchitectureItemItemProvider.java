...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.ArchitectureItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureItemItemProvider
	 ...
	 * @generated
	 */
	public ArchitectureItemItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArchitectureItem_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArchitectureItem_label_feature", "_UI_ArchitectureItem_type"),
				 CorePackage.Literals.ARCHITECTURE_ITEM__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ArchitectureItem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArchitectureItem_type") :
			getString("_UI_ArchitectureItem_type") + " " + label;
	}
