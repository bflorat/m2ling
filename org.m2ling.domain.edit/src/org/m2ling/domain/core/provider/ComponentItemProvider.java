...
public class ComponentItemProvider
	extends ComponentGroupItemProvider
	implements
	...
	protected void addEnginePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_engine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_engine_feature", "_UI_Component_type"),
				 CorePackage.Literals.COMPONENT__ENGINE,
				 true,
				 false,
				 true,
				 null,
