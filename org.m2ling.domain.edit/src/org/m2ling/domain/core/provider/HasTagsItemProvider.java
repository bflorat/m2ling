...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.HasTags} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HasTagsItemProvider
	 ...
	 * @generated
	 */
	public HasTagsItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String[] labelValue = ((HasTags)object).getTags();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_HasTags_type") :
			getString("_UI_HasTags_type") + " " + label;
	}
