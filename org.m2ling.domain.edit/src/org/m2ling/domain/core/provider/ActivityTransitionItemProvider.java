...
/**
 * This is the item provider adapter for a {@link org.m2ling.domain.core.ActivityTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityTransitionItemProvider
	 ...
	 * @generated
	 */
	public ActivityTransitionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityTransition_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityTransition_date_feature", "_UI_ActivityTransition_type"),
				 CorePackage.Literals.ACTIVITY_TRANSITION__DATE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the From Status feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFromStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityTransition_fromStatus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityTransition_fromStatus_feature", "_UI_ActivityTransition_type"),
				 CorePackage.Literals.ACTIVITY_TRANSITION__FROM_STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the To Status feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addToStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityTransition_toStatus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityTransition_toStatus_feature", "_UI_ActivityTransition_type"),
				 CorePackage.Literals.ACTIVITY_TRANSITION__TO_STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActivityTransition"));
	}
