 ...
 * <ul>
 *   <li>{@link org.m2ling.domain.parameters.impl.BoundaryConstraintImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.m2ling.domain.parameters.impl.BoundaryConstraintImpl#isInclusive <em>Inclusive</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class BoundaryConstraintImpl extends ParameterConstraintImpl implements BoundaryConstraint {
	/**
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.BOUNDARY_CONSTRAINT;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.BOUNDARY_CONSTRAINT__VALUE, oldValue, value));
	}
	...
	public void setInclusive(boolean newInclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.BOUNDARY_CONSTRAINT__INCLUSIVE, oldInclusive, inclusive));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.BOUNDARY_CONSTRAINT__VALUE:
				return getValue();
			case ParametersPackage.BOUNDARY_CONSTRAINT__INCLUSIVE:
				return isInclusive();
		}
