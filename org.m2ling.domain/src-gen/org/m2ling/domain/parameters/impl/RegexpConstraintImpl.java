 ...
 * <ul>
 *   <li>{@link org.m2ling.domain.parameters.impl.RegexpConstraintImpl#getRegexp <em>Regexp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RegexpConstraintImpl extends ParameterConstraintImpl implements RegexpConstraint {
	/**
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.REGEXP_CONSTRAINT;
	}
	...
	public void setRegexp(String newRegexp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.REGEXP_CONSTRAINT__REGEXP, oldRegexp, regexp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.REGEXP_CONSTRAINT__REGEXP:
				return getRegexp();
		}
