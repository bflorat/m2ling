 ...
 * <ul>
 *   <li>{@link org.m2ling.domain.principles.impl.RuleImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.m2ling.domain.principles.impl.RuleImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RuleImpl extends ConceptItemImpl implements Rule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final Priority PRIORITY_EDEFAULT = Priority.VERY_LOW;
	...
	protected EClass eStaticClass() {
		return PrinciplesPackage.Literals.RULE;
	}
	...
	public void setStatus(RuleStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrinciplesPackage.RULE__STATUS, oldStatus, status));
	}
	...
	public void setPriority(Priority newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrinciplesPackage.RULE__PRIORITY, oldPriority, priority));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PrinciplesPackage.RULE__STATUS:
				return getStatus();
			case PrinciplesPackage.RULE__PRIORITY:
				return getPriority();
		}
