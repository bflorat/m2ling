 ...
 * @generated
 */
public class PrinciplesFactoryImpl extends EFactoryImpl implements PrinciplesFactory {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public static PrinciplesFactory init() {
		try {
			PrinciplesFactory thePrinciplesFactory = (PrinciplesFactory)EPackage.Registry.INSTANCE.getEFactory("http://m2ling.org/principles/1.0"); 
			if (thePrinciplesFactory != null) {
				return thePrinciplesFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new PrinciplesFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case PrinciplesPackage.RULE: return createRule();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PrinciplesPackage.RULE_STATUS:
				return createRuleStatusFromString(eDataType, initialValue);
			case PrinciplesPackage.PRIORITY:
	 ...
	 * @generated
	 */
	public PrinciplesPackage getPrinciplesPackage() {
		return (PrinciplesPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static PrinciplesPackage getPackage() {
		return PrinciplesPackage.eINSTANCE;
	}

} //PrinciplesFactoryImpl
