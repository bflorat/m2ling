 ...
 * <ul>
 *   <li>{@link org.m2ling.domain.configuration.impl.ParamDefOverriderImpl#getOverridedFeature <em>Overrided Feature</em>}</li>
 *   <li>{@link org.m2ling.domain.configuration.impl.ParamDefOverriderImpl#getEnvironment <em>Environment</em>}</li>
 *   <li>{@link org.m2ling.domain.configuration.impl.ParamDefOverriderImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParamDefOverriderImpl extends EObjectImpl implements ParamDefOverrider {
	...
	protected EClass eStaticClass() {
		return ConfigurationPackage.Literals.PARAM_DEF_OVERRIDER;
	}
	...
	public void setOverridedFeature(EStructuralFeature newOverridedFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PARAM_DEF_OVERRIDER__OVERRIDED_FEATURE, oldOverridedFeature, overridedFeature));
	}
	...
	public void setEnvironment(String newEnvironment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PARAM_DEF_OVERRIDER__ENVIRONMENT, oldEnvironment, environment));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PARAM_DEF_OVERRIDER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfigurationPackage.PARAM_DEF_OVERRIDER__OVERRIDED_FEATURE:
				return getOverridedFeature();
			case ConfigurationPackage.PARAM_DEF_OVERRIDER__ENVIRONMENT:
				return getEnvironment();
			case ConfigurationPackage.PARAM_DEF_OVERRIDER__VALUE:
				return getValue();
		}
