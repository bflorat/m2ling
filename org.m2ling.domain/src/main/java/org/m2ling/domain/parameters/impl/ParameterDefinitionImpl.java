...
public class ParameterDefinitionImpl extends HasCommentImpl implements ParameterDefinition {
	...
	public void setName(String newName) {
		...
		nameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PARAMETER_DEFINITION__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ParametersPackage.PARAMETER_DEFINITION__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, ParametersPackage.PARAMETER_DEFINITION__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == HasNameAndID.class) {
			switch (derivedFeatureID) {
				case ParametersPackage.PARAMETER_DEFINITION__ID: return CorePackage.HAS_NAME_AND_ID__ID;
				case ParametersPackage.PARAMETER_DEFINITION__NAME: return CorePackage.HAS_NAME_AND_ID__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == HasNameAndID.class) {
			switch (baseFeatureID) {
				case CorePackage.HAS_NAME_AND_ID__ID: return ParametersPackage.PARAMETER_DEFINITION__ID;
				case CorePackage.HAS_NAME_AND_ID__NAME: return ParametersPackage.PARAMETER_DEFINITION__NAME;
				default: return -1;
			}
		}
		if (baseClass == HasConstraints.class) {
